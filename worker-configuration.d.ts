/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config dist/server/wrangler.json --strict-vars false --env-file .env.example` (hash: 25bc0139fa6805ebcc18b7527a5fd68a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_CHAT_COMPLETIONS_URL" | "AI_MODEL">> {}
}
